document.addEventListener('DOMContentLoaded',()=>{
  ...
  // --- Accounts dedicated to Aboriginal Australian culture ---
  const specializedAccounts = {
    education: {name: 'Cultural Education', avatar: '📚', color: '#0b66c3'},
    preservation: {name: 'Cultural Preservation', avatar: '🛡️', color: '#16a34a'},
    artcraft: {name: 'Traditional Arts', avatar: '🎨', color: '#dc2626'},
    community: {name: 'Community Keepers', avatar: '🤝', color: '#7c3aed'}
  };

  const culturePosts = [
  {user:'Cultural Education',account:'education',loc:'Perth Schools',img:'assets/012523PD-JPG1.jpg',caption:'Transforming Education: Young Noongar students engage in immersive cultural learning sessions at Perth schools, where traditional knowledge meets modern pedagogy. These innovative programs integrate Noongar language, storytelling, and cultural practices into mainstream curriculum, ensuring that Indigenous knowledge systems are valued and preserved for future generations. The children learn not just words, but the deep cultural connections between language, land, and identity that have sustained Noongar people for over 60,000 years.',category:'language'},
  {user:'Cultural Preservation',account:'preservation',loc:'South West WA',img:'assets/960.webp',caption:'Sacred Country Connection: The breathtaking landscapes of South West Western Australia tell the ancient stories of Noongar people through every river bend, granite outcrop, and native forest. This image captures the profound spiritual relationship between Noongar people and their traditional country, where every feature holds cultural significance and Dreamtime stories. Land management practices passed down through millennia continue to inform contemporary conservation efforts, demonstrating how Indigenous knowledge provides sustainable solutions for environmental stewardship.',category:'story'},
  {user:'Traditional Arts',account:'artcraft',loc:'Perth',img:'assets/a_230211gennoongar02.jpg',caption:'Living Art Traditions: Master craftspeople demonstrate the intricate techniques of traditional Noongar art creation, using natural materials harvested sustainably from the local environment. These artistic practices represent thousands of years of cultural knowledge, with each pattern, color, and technique carrying deep spiritual and practical meaning. Contemporary Noongar artists blend traditional methods with modern materials, creating powerful works that bridge ancestral wisdom with contemporary expression, ensuring these vital cultural practices remain vibrant and relevant.',category:'art'},
  {user:'Cultural Education',account:'education',loc:'Albany',img:'assets/familli1.jpeg',caption:'Intergenerational Knowledge Transfer: A powerful moment of cultural transmission as Noongar elders share traditional knowledge with younger family members during a community gathering in Albany. These intimate family sessions are crucial for language preservation, where grandparents teach grandchildren not just vocabulary, but the cultural context, protocols, and deep meanings embedded within Noongar language. The warmth and connection visible here represents the resilience of Noongar culture and the determination of families to maintain their linguistic heritage despite historical challenges.',category:'language'},
  {user:'Cultural Preservation',account:'preservation',loc:'Margaret River',img:'assets/images.jpg',caption:'Dreamtime Stories Alive: In the stunning Margaret River region, traditional storytellers continue the ancient practice of sharing Dreamtime stories that explain the creation of the landscape and provide moral and practical guidance for living in harmony with country. These narratives, passed down orally for thousands of generations, contain complex astronomical, ecological, and social knowledge systems. Each story is carefully preserved and shared in appropriate cultural contexts, maintaining the integrity of sacred knowledge while educating community members about their rich cultural heritage.',category:'story'},
  {user:'Cultural Education',account:'education',loc:'Denmark',img:'assets/Keeping Noongar alive.webp',caption:'Language Revival Movement: Dedicated community educators work tirelessly to keep the Noongar language alive through innovative teaching methods and community engagement programs in Denmark, WA. This grassroots movement combines traditional learning methods with modern technology, creating apps, online resources, and interactive materials that make language learning accessible to all ages. The program focuses on practical vocabulary for daily use while maintaining the cultural protocols and deeper meanings that give Noongar language its spiritual significance.',category:'language'},
  {user:'Traditional Arts',account:'artcraft',loc:'Fremantle',img:'assets/Noongar-6-seasons-series-III.jpg',caption:'Six Seasons Wisdom: Beautiful artistic representation of the Noongar six-season calendar system, which demonstrates sophisticated ecological knowledge developed over millennia of careful observation of local environmental patterns. Unlike the European four-season model, the Noongar calendar recognizes Birak (December-January), Bunuru (February-March), Djeran (April-May), Makuru (June-July), Djilba (August-September), and Kambarang (October-November), each with distinct weather patterns, food availability, and cultural activities. This traditional knowledge system guides sustainable resource management and cultural practices.',category:'art'},
  {user:'Cultural Education',account:'education',loc:'Bunbury',img:'assets/noongar.gif',caption:'Dynamic Language Learning: Interactive digital resources bring Noongar language to life through animated content that engages learners of all ages in Bunbury community programs. These innovative educational tools combine traditional storytelling with modern animation techniques, making language learning fun and accessible while respecting cultural protocols. The programs include proper pronunciation guides, cultural context explanations, and interactive exercises that help learners understand not just what words mean, but how they connect to Noongar worldview and daily life.',category:'language'},
  {user:'Cultural Preservation',account:'preservation',loc:'Mandurah',img:'assets/Noongar5.23.jpg',caption:'Heritage Protection Initiative: Community members in Mandurah work to document, preserve, and protect significant Noongar cultural sites and practices for future generations. This comprehensive preservation effort includes oral history recording projects, traditional ecological knowledge documentation, and sacred site protection programs. Elder knowledge holders share their expertise with younger community members, ensuring that crucial cultural information is not lost. The initiative also focuses on legal protection of culturally significant areas and integration of traditional knowledge into modern land management practices.',category:'story'},
  {user:'Community Keepers',account:'community',loc:'Perth',img:'assets/Olman_Walley_Noongar_Performer.jpg',caption:'Cultural Performance and Identity: Renowned Noongar performer Olman Walley demonstrates the power of traditional dance, music, and storytelling to maintain cultural identity and educate broader communities about Noongar heritage. Through powerful performances that combine traditional elements with contemporary presentation, cultural ambassadors like Olman bridge the gap between ancient wisdom and modern understanding. These performances serve multiple purposes: preserving traditional arts, educating non-Indigenous audiences, strengthening cultural identity within Noongar communities, and inspiring young people to engage with their heritage.',category:'story'},
  {user:'Cultural Preservation',account:'preservation',loc:'Bunbury',img:'assets/SWNTS+areas.webp',caption:'Traditional Territory Mapping: Comprehensive mapping project documenting the traditional territories and boundaries of Noongar groups across the South West of Western Australia. This important work combines traditional knowledge from elders with modern mapping technology to create accurate representations of cultural boundaries, sacred sites, and traditional resource areas. The maps serve legal, educational, and cultural purposes, supporting native title claims, informing land management decisions, and educating both Indigenous and non-Indigenous people about the complex social and territorial systems that have governed Noongar society for thousands of years.',category:'story'},
  ];
  ...
  function showSpecializedProfile(accountType, username) {
    ...
    alert(`Profile of ${username}\n\n${account.avatar} Specialized account for Aboriginal Australian cultural preservation\n\n${posts.length} posts\n1.2K followers\n\nMission: Preserve, protect, and transmit Aboriginal cultural knowledge, language, and traditions to future generations through education, community engagement, and innovative cultural programs.`);
  }
  ...
  function showDynamicProfile(username) {
    ...
    document.getElementById('dynamicProfileBio').textContent = (username === 'Riche') ? 'Aboriginal Australian culture enthusiast. Sharing stories, language, and traditional knowledge.' : 'Member of the Aboriginal cultural preservation community.';
    // Fill posts grid
